---
title: "Methods 4 -- Portfolio Assignment 2, Study Group 3"
output:
...
```{r}
adjustmentSets(dag_corona,exposure="social_exposure", outcome="OCD") # { corona_fear }
...
*As seen in the above plot, social exposure becomes independent from OCD (i.e., the model estimates the coefficient bSoExp to be very close to zero (.05) when stratifying by corona fear.*
...
```{r}
adjustmentSets(dag_corona,exposure="germ_level", outcome="corona_fear") # No extra to add
...
```{R} 
adjustmentSets(dag_corona,exposure="social_exposure", outcome="sanitizing")
